...
class CyberbullyingDetector:
    ...
    def extract_text_from_image(self, image_path):
        ...
        print("EXTRACTINGEXTRACTINGEXTRACTINGEXTRACTINGEXTRACTINGEXTRACTINGEXTRACTING TEXT FROM IMAGE...")
    ...
    def extract_text_from_image(self, image_path, lang='eng', custom_config=None):
        """
        Extract text from an image using Tesseract OCR.
        Includes advanced preprocessing for higher accuracy.
        
        Args:
            image_path (str): Path to the input image.
            lang (str): OCR language. Default is English ('eng').
            custom_config (str): Custom Tesseract configuration.
        
        Returns:
            str: Extracted text or a user-friendly error message.
        """
        print("IMPROVED IMAGE TEXT EXTRACT FUNCTION CALLED")
        if not IMAGE_PROCESSING_AVAILABLE:
        ...
        try:
            ...
            # Step 1: Resize image if it's too small (increase DPI)
            ...
            # Step 4: Noise removal with dilation and erosion
            ...
            # Use multiple Tesseract configurations for better results
            configs = custom_config or [
                '--oem 3 --psm 6',    # Assume block of text
